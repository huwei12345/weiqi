...
QT_MOC_LITERAL(5, 37, 9), // "startKata"
QT_MOC_LITERAL(6, 47, 10), // "getAIPiece"
QT_MOC_LITERAL(7, 58, 5), // "Piece"
QT_MOC_LITERAL(8, 64, 8), // "nowPiece"
...
void Kata::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { int _r = _t->startKata();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 2: _t->getAIPiece((*reinterpret_cast< Piece(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
